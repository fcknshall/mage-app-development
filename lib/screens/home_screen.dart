...
class _HomeScreenState extends State<HomeScreen> {
  ...
  SliverToBoxAdapter _timerbox(){
    return SliverToBoxAdapter(
      ...
      children:  [ 
        Text("Isoman Countdown                         ", style: TextStyle(
          fontFamily: "Kanit",
          fontSize: 24,
        ...
        child: Column(
          ...
          children: [
           ...
           child: Text("Sisa Waktu Karantina Anda                 \nTinggal : ", 
  ...
  SliverToBoxAdapter _saranbox() {
    return SliverToBoxAdapter(
      ...
      children:  [
        ...
        Text("Saran Kegiatan :                               ", style: TextStyle(
          fontFamily: "Kanit",
          fontSize: 24,
          color: Color.fromRGBO(245, 253, 104, 1),
        ),),
  ...
  children: [
    ...
    GestureDetector(
      ...
      child: Container(
        ...
        Container(
              padding: EdgeInsets.all(5) ,
              child: Text("> Olahraga :                           \n - Yoga \n> Makanan :\n -Salad Buah & Sayur",style: TextStyle(
          fontFamily: "Kanit",
          fontSize: 20,
          color: Color.fromRGBO(245, 253, 104, 1),
        ),
